...
// Regresa todas las posibles jugadas en las que la PC puede ganar
function checkIfCanWin() {
  const arr = JSON.parse(JSON.stringify(board)); // Clonar el tablero

  // Revisar si puede ganar en las filas
